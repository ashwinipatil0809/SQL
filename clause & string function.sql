...
INSERT INTO employee(emp_id,emp_name,salary,location) VALUES (101,"Onkar",30000,"Delhi"),(102,"Suresh",33000,"Pune"),(103,"Ramesh",32000,"Pune"),(104,"paras",50000,"Hydrabad"),(105,"aishu",70000,"Delhi");
...
SELECT emp_name,salary FROM employee ORDER BY salary DESC LIMIT 1,2 ;
 ...
 GROUP BY location HAVING countofemp>1;
 ...
 HAVING count(emp_id)>1;
  ...
  SELECT location,salary FROM employee ORDER BY location IS NULL,salary DESC; -- add null
 
 
 SELECT emp_name,LENGTH(emp_name) FROM employee;
 SELECT LENGTH('this is a book')from dual;
...
select emp_id,emp_name,salary FROM employee WHERE salary>20000;